...
public class HeadCommands {
    ...
    public static void head(CommandSource sender, String[] args) {
        ...
        sender.sendMessage(Text.of(TextColors.AQUA,
                                   "To set a sign with a head, just place the head, then place the sign either above or below it."));
        sender.sendMessage(Text.of(TextColors.AQUA,
                                   "To create a sign of a specific type just put the code on the first line. # denotes the number."));
        sender.sendMessage(Text.of(TextColors.AQUA,
                                   " Example: [donation2] would show the second most recent donation."));
        sender.sendMessage(Text.of(TextColors.AQUA,
                                   "If there are sub-types, those go on the second line of the sign."));
        ...
        sender.sendMessage(Text.of(TextColors.GRAY,
                                   " Subtypes: ",
                                   TextColors.RESET,
                                   " Place the item id on the second line to only get donations for that package."));
        sender.sendMessage(Text.of(TextColors.GOLD, "[topvoter#] ", TextColors.RESET, " - Top voter of the month."));
        sender.sendMessage(Text.of(TextColors.GRAY,
                                   " Subtypes: ",
                                   TextColors.RESET,
                                   " day, week, month. Changes it to the top voter of the day/week/month."));
        ...
        sender.sendMessage(Text.of(TextColors.GOLD,
                                   "[toppoints#] ",
                                   TextColors.RESET,
                                   " - Which player has the most unspent points."));
        sender.sendMessage(Text.of(TextColors.GOLD,
                                   "[pointsspent#] ",
                                   TextColors.RESET,
                                   " - Player which has spent the most points overall."));
        sender.sendMessage(Text.of(TextColors.GRAY,
                                   " Subtypes: ",
                                   TextColors.RESET,
                                   " day, week, month. Changes the range to day/week/month."));
        sender.sendMessage(Text.of(TextColors.GOLD,
                                   "[moneyspent#] ",
                                   TextColors.RESET,
                                   " - Player which has spent the most money on the server overall."));
        sender.sendMessage(Text.of(TextColors.GRAY,
                                   " Subtypes: ",
                                   TextColors.RESET,
                                   " day, week, month. Changes the range to day/week/month."));
