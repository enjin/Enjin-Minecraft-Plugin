...
public class StatCommands {
    ...
    public static void customStat(CommandSource sender, String[] args) {
        if (args.length == 5) {
            ...
            sender.sendMessage(Text.of(TextColors.DARK_RED,
                                       "Usage: /enjin customstat <player> <plugin> <stat-name> <stat-value> <cumulative>"));
        }
    }
    ...
    public static void playerStats(CommandSource sender, String[] args) {
        ...
        if (args.length == 1) {
            ...
            if (player != null) {
                sender.sendMessage(Text.of(TextColors.DARK_GREEN,
                ...
                sender.sendMessage(Text.of(TextColors.DARK_GREEN,
                                           "Blocks broken: ",
                                           TextColors.GOLD,
                                           player.getBrokenblocks()));
                sender.sendMessage(Text.of(TextColors.DARK_GREEN,
                                           "Blocks placed: ",
                                           TextColors.GOLD,
                                           player.getPlacedblocks()));
                sender.sendMessage(Text.of(TextColors.DARK_GREEN,
                                           "Block types broken: ",
                                           TextColors.GOLD,
                                           player.getBrokenblocktypes().toString()));
                sender.sendMessage(Text.of(TextColors.DARK_GREEN,
                                           "Block types placed: ",
                                           TextColors.GOLD,
                                           player.getPlacedblocktypes().toString()));
                sender.sendMessage(Text.of(TextColors.DARK_GREEN,
                                           "Foot distance traveled: ",
                                           TextColors.GOLD,
                                           player.getFootdistance()));
                sender.sendMessage(Text.of(TextColors.DARK_GREEN,
                                           "Boat distance traveled: ",
                                           TextColors.GOLD,
                                           player.getBoatdistance()));
                sender.sendMessage(Text.of(TextColors.DARK_GREEN,
                                           "Minecart distance traveled: ",
                                           TextColors.GOLD,
                                           player.getMinecartdistance()));
                sender.sendMessage(Text.of(TextColors.DARK_GREEN,
                                           "Pig distance traveled: ",
                                           TextColors.GOLD,
                                           player.getPigdistance()));
            } else {
    ...
    public static void serverStats(CommandSource sender, String[] args) {
        ...
        sender.sendMessage(Text.of(TextColors.DARK_GREEN,
                                   "Total number of creeper explosions: ",
                                   TextColors.GOLD,
                                   plugin.getServerStats().getCreeperexplosions()));
        sender.sendMessage(Text.of(TextColors.DARK_GREEN,
                                   "Total number of kicks: ",
                                   TextColors.GOLD,
                                   plugin.getServerStats().getTotalkicks()));
        sender.sendMessage(Text.of(TextColors.DARK_GREEN,
                                   "Kicks per player: ",
                                   TextColors.GOLD,
                                   plugin.getServerStats().getPlayerkicks().toString()));
    }
}
