...
import com.enjin.bungee.api.EnjinAPI;
import com.enjin.bungee.api.PlayerTag;
...
public class EnjinRetrievePlayerTags implements Runnable {
    ...
    public EnjinRetrievePlayerTags(String player, CommandSender requester, EnjinPlugin plugin) {
        this.player = player;
