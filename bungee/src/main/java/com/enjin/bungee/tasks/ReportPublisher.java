...
public class ReportPublisher implements Runnable {
    ...
    public synchronized void run() {
        ...
        try {
            ReverseFileReader rfrlog = new ReverseFileReader(plugin.getDataFolder()
        ...
        builder.append("\n=========================================\nEnjin HTTPS test: ")
               ...
               .append("\n");
        builder.append("Enjin HTTP test: ")
        ...
        builder.append("Enjin web connectivity test: ")
               ...
               .append("\n");
        builder.append("Is mineshafter present: ")
        ...
        try {
            ...
            sender.sendMessage(ChatColor.GOLD + "Enjin report created in " + zip.getFile()
