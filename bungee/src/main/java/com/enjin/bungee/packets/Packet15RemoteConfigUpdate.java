...
import com.enjin.bungee.ConfigValueTypes;
...
public class Packet15RemoteConfigUpdate {
    ...
    public static void handle(BufferedInputStream in, EnjinPlugin plugin) {
        try {
            ...
            EnjinPlugin.debug("Changing these values in the config: \"" + values);
            ...
            plugin.getLogger().warning("Failed to set config variables via 0x15, " + t.getMessage());
            t.printStackTrace();
        }
    }
}
