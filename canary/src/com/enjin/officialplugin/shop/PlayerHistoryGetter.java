...
public class PlayerHistoryGetter implements Runnable {
	...
	public PlayerHistoryGetter(ShopListener listener, Player player, String historyplayer) {
	...
	public void run() {
		...
		try {
			...
			if(page == null) {
				player.sendMessage(Colors.LIGHT_RED + "There was a problem loading the player history, please try again later.");
				return;
			}
