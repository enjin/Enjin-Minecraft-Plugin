...
public class PexListener extends PermissionListener {
	private static final Pattern PEX_USER_PARENT_ADD_GROUP = Pattern.compile("^(?:pex|permissionsex|permissions) user ([a-zA-Z0-9_]{2,16}) (?:parent|parents) (?:add|a|\\+|remove|rem) group (?:[a-zA-Z0-9]{1,32})$");
