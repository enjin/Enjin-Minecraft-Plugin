...
public class ConfigCommand {
    ...
    private static void help(CommandSource sender) {
        ...
        sender.sendMessage(Text.of(TextColors.GOLD, "USAGE: /e config <key> <value>"));
        sender.sendMessage(Text.of(TextColors.GREEN, "Keys: ", builder.toString()));
    }

    private static void process(CommandSource sender, ConfigKey key, String rawValue) {
        Object value = null;
        try {
            ...
            sender.sendMessage(Text.of(TextColors.RED, key.name(), " must be of type ", key.type.getSimpleName()));
            return;
        }

        if (value == null) {
            sender.sendMessage(Text.of(TextColors.RED, "Was unable to process raw value for ", key.name()));
            return;
        }
        ...
        if (success) {
            ...
            sender.sendMessage(Text.of(TextColors.GREEN, key.name(), " was set to ", value));
        }
    }
